...
def actualizar_json(carpeta, fichero):
    ...
    nuevo_empleado = {'id': ultimo_id + 1, **nuevo_empleado} #** es un método para añadir a un diccionario todos los elementos de otro.
    #Aquí está el diccionario {'id': ultimo_id + 1} + todos los elementos del diccionario nuevo empleado. Para conseguir que el id esté en 1ª posición
