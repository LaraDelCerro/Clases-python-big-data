#El objetivo del ejercicios es guardar los datos de los alumnos aprobados y suspensos en dos ficheros json llamados aprobados.json y suspensos.json dentro de una carpeta data 
#que no podemos crear manualmente
...
def main():
    aprobados, suspensos = aprobados_suspensos (lista_alumnos)
    crear_json('data', 'aprobados.json', aprobados)
    crear_json('data', 'suspensos.json', suspensos)
